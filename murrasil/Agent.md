...
| الأمر | الوظيفة |
|-------|---------|
| `setup.bat` | تهيئة المشروع وتثبيت المكتبات لمرة واحدة |
| `start.bat` | تشغيل الخادم وفتح المتصفح تلقائياً |
| `stop.bat` | إيقاف تشغيل الخادم بكل أمان |
| `python main.py` | أو `uvicorn main:app --reload` لتشغيل الخادم يدوياً |
| `pip install -r requirements.txt` | تثبيت الاعتماديات يدوياً |
